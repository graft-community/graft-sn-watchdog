...
class GraftSN(object):
        ...
        def __init__(self):
                ...
                GraftSN.snbotname = "" # Put your SN name detail here if running multiple SNS, you also may need to change ports above if more than one port used per sn 
                self.loop()
